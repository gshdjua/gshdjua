  ...
  <div class="index-page">
      ...
      <section v-if="currentTab==='assistant'" class="assistant-page">
        ...
        <div class="chat-panel" @click="showAssistantSettingsMenu = false">
          <div class="chat-history-toolbar">
            ...
            <div class="assistant-settings-wrap">
              <button class="assistant-settings-btn" title="AI 助手设置" aria-label="AI 助手设置" @click.stop="showAssistantSettingsMenu = !showAssistantSettingsMenu">⚙</button>
              <div v-if="showAssistantSettingsMenu" class="assistant-settings-menu">
                <button @click="openMemoryManager"><span>◇</span><div><strong>记忆与隐私</strong><small>查看和控制长期记忆</small></div></button>
              </div>
            </div>
          </div>
    ...
    <div v-if="showMemoryDialog" class="memory-dialog-overlay" @click.self="showMemoryDialog = false">
      <section class="memory-dialog">
        <header>
          <div><span>MEMORY & PRIVACY</span><h3>记忆与隐私</h3></div>
...
export default {
  ...
  methods: {
    ...
    async openMemoryManager() {
      this.showAssistantSettingsMenu = false
